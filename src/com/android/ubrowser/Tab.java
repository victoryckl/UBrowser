...
import com.android.ubrowser.TabControl.OnThumbnailUpdatedListener;
import com.android.ubrowser.homepages.HomeProvider;
import com.android.ubrowser.provider.BrowserProvider2.Thumbnails;
...
class Tab implements PictureListener {
    ...
    private static final boolean LOGD_ENABLED = com.android.ubrowser.Browser.LOGD_ENABLED;
    ...
    // of the browser.
    private static final String CONSOLE_LOGTAG = "ubrowser";
